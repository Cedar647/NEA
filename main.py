...
credits_button = button(265, 466, pygame.image.load("Button/button_credits.png"),1) #credits button
...
class enemy(character):
    def __init__(self):
        character.__init__(self, 15, 15, 15, 15, 10,825)
        self.char_class = "Orc"
        self.name = "Enemy"
...
while game_is_running: #main game loop
    ...
    if screen_state == "Menu": #checks if game is currently on main menu
        draw_background()
        draw_text("Turn-based game v1.0", title_font, black, 120, 100)
...
#forge
        ...
        screen.fill(white) #blank screen
        return_to_menu_b.draw()
        draw_text("Credits", title_font, black, 25, 25) #write text
        draw_text("Warrior by Mattz Art: https://xzany.itch.io/free-knight-2d-pixel-art", small_font, black, 25, 90)
        draw_text("Goblin by Zerie: https://zerie.itch.io/tiny-rpg-character-asset-pack", small_font, black, 25, 120)
        draw_text("Buttons by Cedar", small_font,black, 25, 150)
        draw_text("Some coding support from Coding With Russ: ", small_font,black,  25, 180)
        draw_text(" => https://www.youtube.com/watch?v=Vlolidaoiak&list=PLjcN1EyupaQnvpv61iriF8Ax9dKra-MhZ", small_font, black, 25, 205)
        if return_to_menu_b.click_check(): #allow return button to change screen to main menu
            screen_state = "Menu"
            pygame.display.set_caption("Main Menu")
